...
public class AntProperties {
     ...
     * }
     * 
     * public static int calculateMaturingTime(ItemStack item1, ItemStack item2)
     * {
     * 
     ...
     * }
     * 
     * public static boolean calculateWinged(ItemStack item1, ItemStack item2) {
     * 
     ...
     * }
     * 
     * public static int calculateLifetime(ItemStack item1, ItemStack item2) {
     * 
     ...
     * }
     * 
     * public static boolean calculateNocturnal(ItemStack item1, ItemStack
     * item2) {
     * 
	...
	/*
	 * Nbt.set(itemStack, FERTILITY_KEY, fertility); Nbt.set(itemStack,
	 * MATURING_TIME_KEY, maturingTime); Nbt.set(itemStack, WINGED_KEY,
	 * winged);
	 */
	Nbt.set(itemStack, LIFETIME_COMPLETE_KEY, lifetimeComplete);
	Nbt.set(itemStack, MATED_KEY, mated);
	/*
	 * Nbt.set(itemStack, LIFETIME_TOTAL_KEY, lifetime); Nbt.set(itemStack,
	 * NOCTURNAL_KEY, nocturnal);
	 */
     ...
     * }
     * 
     * public static int getMaturingTime(ItemStack itemStack) {
     * 
     * Nbt.setTag(itemStack);
     * 
