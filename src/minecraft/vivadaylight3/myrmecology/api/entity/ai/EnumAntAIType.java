...
public enum EnumAntAIType {
    ...
    DAMAGE("Damaging"), DESTRUCTION("Destructive"), FARMING("Farming"), SCAVENGING("Scavenging");
	...
	this.enabled = Register.config.get(Configuration.CATEGORY_GENERAL, this.name + " ant AI enabled", true).getBoolean(true);
