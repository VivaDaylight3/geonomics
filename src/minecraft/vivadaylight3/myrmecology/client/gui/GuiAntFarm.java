...
public class GuiAntFarm extends GuiContainer
{
    ...
    public GuiAntFarm(InventoryPlayer playerInventory, TileEntityAntFarm tileEntity, World world, 
    		int x, int y, int z)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture(Myrmecology.GUI_PATH+"antFarm2.png");
