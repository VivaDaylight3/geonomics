...
public class AntBookText extends TextContent {
	...
	String s2 = EnumChatFormatting.BOLD + "" + EnumChatFormatting.UNDERLINE
		+ "Contents" + EnumChatFormatting.RESET;
	...
	String s12 = EnumChatFormatting.BOLD + "Queens: "
		+ EnumChatFormatting.RESET
		+ "Used for breeding ants into new species.";
	String s13 = EnumChatFormatting.BOLD + "Drones: "
		+ EnumChatFormatting.RESET
		+ "Mate with queen ants when breeding.";
	String s14 = EnumChatFormatting.BOLD + "Workers: "
		+ EnumChatFormatting.RESET
		+ "Perform tasks unique to the species.";
	String s15 = EnumChatFormatting.BOLD
		+ "Larvae: "
		+ EnumChatFormatting.RESET
		+ "The result of breeding and hill extraction, can be incubated into one of the other ant types.";
	...
	String s19 = EnumChatFormatting.BOLD + "Queen: "
		+ EnumChatFormatting.RESET + "Gold nugget";
	String s20 = getNewLine(s19);
	String s21 = EnumChatFormatting.BOLD + "Drone: "
		+ EnumChatFormatting.RESET + "Bone" + getNewLine(s19);
	String s22 = getNewLine(s21);
	;
	String s23 = EnumChatFormatting.BOLD + "Worker: "
		+ EnumChatFormatting.RESET + "Stick" + getNewLine(s20);
	...
	return new String[] { newBookPage(true, t7, t8, t9, t10),
		newBookPage(true, s2, s2a, s3, s4, s5, s6, s7),
		newBookPage(true, s10, s11),
		newBookPage(true, s12, s13, s14, s15), newBookPage(true, s16),
		newBookPage(true, s17, s18),
