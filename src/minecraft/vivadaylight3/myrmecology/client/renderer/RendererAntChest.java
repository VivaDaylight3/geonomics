...
public class RendererAntChest extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAntChestAt(TileEntityAntChest par1TileEntityAntChest, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            ...
            if (block instanceof BlockChest && i == 0)
            {
                try
                {
                    ((BlockChest)block).unifyAdjacentChests(par1TileEntityAntChest.getWorldObj(), par1TileEntityAntChest.xCoord, par1TileEntityAntChest.yCoord, par1TileEntityAntChest.zCoord);
                }
                catch (ClassCastException e)
                {
                    FMLLog.severe("Attempted to render a chest at %d,  %d, %d that was not a chest",
                            par1TileEntityAntChest.xCoord, par1TileEntityAntChest.yCoord, par1TileEntityAntChest.zCoord);
                }
                i = par1TileEntityAntChest.getBlockMetadata();
            }
        ...
        if (par1TileEntityAntChest.adjacentChestZNeg == null && par1TileEntityAntChest.adjacentChestXNeg == null)
        {
            ModelChest modelchest = null;

            if (par1TileEntityAntChest.adjacentChestXPos == null && par1TileEntityAntChest.adjacentChestZPosition == null)
            {
            ...
            GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
            float f1 = par1TileEntityAntChest.prevLidAngle + (par1TileEntityAntChest.lidAngle - par1TileEntityAntChest.prevLidAngle) * par8;
            float f2;

            if (par1TileEntityAntChest.adjacentChestZNeg != null)
            {
                f2 = par1TileEntityAntChest.adjacentChestZNeg.prevLidAngle + (par1TileEntityAntChest.adjacentChestZNeg.lidAngle - par1TileEntityAntChest.adjacentChestZNeg.prevLidAngle) * par8;
            ...
            {
                f2 = par1TileEntityAntChest.adjacentChestXNeg.prevLidAngle + (par1TileEntityAntChest.adjacentChestXNeg.lidAngle - par1TileEntityAntChest.adjacentChestXNeg.prevLidAngle) * par8;
    ...
    {
        this.renderTileEntityAntChestAt((TileEntityAntChest)par1TileEntity, par2, par4, par6, par8);
    }
