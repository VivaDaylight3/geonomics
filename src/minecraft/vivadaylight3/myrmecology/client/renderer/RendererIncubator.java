...
public class RendererIncubator extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler{
	...
	if(itemstack != null){
	    ...
	    if(itemstack.getItem() instanceof ItemAnt && itemstack.getItemDamage() == Metadata.getMetaLarva()){
