...
public class BlockAntChest extends BlockContainer {
    ...
    {
	TileEntityAntChest tileentitychest = (TileEntityAntChest) world.getBlockTileEntity(i, j, k);
    ...
    {
        return Container.calcRedstoneFromInventory((TileEntityAntChest) par1World.getBlockTileEntity(par2, par3, par4));
    }
