...
public class AntObjective {
    ...
    public AntObjective(IEntityAnt ant, int x, int y, int z, String name,
	    int distance) {
	...
	return Environment.coordinateIsCloseTo(theAnt.getPosX(),
		theAnt.getPosY(), theAnt.getPosZ(), this.getTargetX(),
		this.getTargetY(), this.getTargetZ(), distance);
