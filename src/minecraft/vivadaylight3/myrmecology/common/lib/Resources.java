...
public class Resources{
    ...
    public static final ResourceLocation GUI_ANTFARM = getResourceLocation(GUI_LOCATION + Register.BLOCK_ANTFARM_NAME + FORMAT);
    public static final ResourceLocation GUI_INCUBATOR = getResourceLocation(GUI_LOCATION + Register.BLOCK_INCUBATOR_NAME + FORMAT);
