...
/**
 * Creates an instance of StringForge. StringForge is used for advanced string management.
 * @author samueltebbs
 *
 */
public class StringForge {
    ...
    /**
     * Places the given string at the given index and moves the current one at that index to the end
     * @param str
     * @param index
     */
    ...
    /**
     * Reverses the positions of this StringForge's strings. E.g a StringForge with the strings: "Oh," "Hi" "there!" will
     * become "there!" "Hi" "Oh"
     */
    public void reverse(){
