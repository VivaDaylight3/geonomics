...
public class TreeDictionary {
	...
	addTreeEntry(new TreeEntry(new BlockIDEntry(Block.wood.blockID), new BlockIDEntry(Block.leaves.blockID)));
	addTreeEntry(new TreeEntry(new BlockIDEntry(Block.wood.blockID, 1), new BlockIDEntry(Block.leaves.blockID, 1)));
	addTreeEntry(new TreeEntry(new BlockIDEntry(Block.wood.blockID, 2), new BlockIDEntry(Block.leaves.blockID, 2)));
	addTreeEntry(new TreeEntry(new BlockIDEntry(Block.wood.blockID, 3), new BlockIDEntry(Block.leaves.blockID, 3)));
	...
	for(int k = 0; k < leafList.size(); k++){
		...
		if(getTreeEntryFromLog(logList.get(k)) != null && getTreeEntryFromLeaf(leafList.get(k)) != null){
