...
public class Url {
	...
	if (Integer.parseInt(result[0]) >= Integer
		.parseInt(Reference.VERSION_MAJOR)) {

	    return VERSION_TYPE_1;

	} else if (Integer.parseInt(result[1]) >= Integer
		.parseInt(Reference.VERSION_MINOR)) {

	    return VERSION_TYPE_2;

	} else if (Integer.parseInt(result[2]) >= Integer
		.parseInt(Reference.VERSION_BUILD)) {
	...
	if (type == VERSION_TYPE_1 || type == VERSION_TYPE_2
		|| type == VERSION_TYPE_3) {
