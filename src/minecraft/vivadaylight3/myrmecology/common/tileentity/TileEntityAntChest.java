...
public class TileEntityAntChest extends TileEntity implements IInventory {
    ...
    public void updateEntity()
    {
        ...
        {
            worldObj.addBlockEvent(xCoord, yCoord, zCoord, Register.blockAntChest.blockID, 3, ((numUsingPlayers << 3) & 0xF8) | (facing & 0x7));
        }
    ...
    public void openChest()
    {
        ...
        numUsingPlayers++;
        worldObj.addBlockEvent(xCoord, yCoord, zCoord, Register.blockAntChest.blockID, 1, numUsingPlayers);
    }
    ...
    public void rotateAround(ForgeDirection axis)
    {
        ...
        worldObj.addBlockEvent(xCoord, yCoord, zCoord, Register.blockAntChest.blockID, 2, getFacing());
    }
}
